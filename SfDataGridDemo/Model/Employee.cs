...
namespace SfDataGridDemo
{
    public class Employee : INotifyPropertyChanged
    {
        ...
        public Employee(bool selected, string name, string designation, string mail, string location, string trust, string status, double proficiency, int salary, string address, string gender)
        {
            Selected = selected;
            EmployeeName = name;
